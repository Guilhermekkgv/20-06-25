...
function NEVERLOSE:AddWindow(NameScriptHub,Text,UICustomSize)
	...
	local ooldsize = UICustomSize or UDim2.fromOffset(495, 380)
	local Tabs={}
	...
	local function ui_toggleong(val)
		...
		if val then
			...
			if headd2text then
				TweenService:Create(headd2text,TweenInfo.new(0.3),{TextTransparency=0}):Play()
			end

			TweenService:Create(UserName,TweenInfo.new(0.3),{TextTransparency=0}):Play()
			...
			TweenService:Create(Frame_3,TweenInfo.new(0.3),{BackgroundTransparency=0}):Play()
			...
			if headd2text then
				TweenService:Create(headd2text,TweenInfo.new(0.3),{TextTransparency=1}):Play()
			end

			TweenService:Create(UserName,TweenInfo.new(0.3),{TextTransparency=1}):Play()
	...
	Frame.BackgroundColor3 = NEVERLOSE.Themes.SectionColor
	...
	Frame_2.BackgroundColor3 = NEVERLOSE.Themes.SectionColor
	...
	Frame_3.BackgroundColor3 = NEVERLOSE.Themes.SectionColor
	...
	HeadName.BackgroundColor3 = NEVERLOSE.Themes.SectionColor
	HeadName.BackgroundTransparency = 0
	...
	TabButtons.BackgroundColor3 = Color3.fromRGB(13, 13, 13)
	...
	UserData.BackgroundColor3 = NEVERLOSE.Themes.SectionColor
	UserData.BackgroundTransparency = 0
